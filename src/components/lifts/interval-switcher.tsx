    ...
    >
      {intervals.map((interval) => (
        <ToggleGroup.Item
          ...
          className='h-8 rounded px-3 outline-none hover:bg-neutral-200 focus:bg-neutral-200 radix-state-on:bg-neutral-200 hover:dark:bg-neutral-800 focus:dark:bg-neutral-800 radix-state-on:dark:bg-neutral-800'
        >
          {interval.label}
        </ToggleGroup.Item>
      ))}
