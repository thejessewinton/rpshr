    ...
    <>
      <Drawer.Root direction="left" open={open} onOpenChange={setOpen}>
        ...
        <Drawer.Portal>
          ...
          <Drawer.Content
            className="fixed top-2 bottom-2 left-2 z-10"
            style={
              {
          ...
          >
            <div className="flex h-full w-72 flex-col items-center rounded-2xl border border-neutral-300/40 bg-neutral-50 p-4 backdrop-blur-md dark:border-neutral-700/40 dark:bg-neutral-900">
