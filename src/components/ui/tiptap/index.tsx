  ...
  return (
    <EditorProvider
      ...
      editorProps={{
        attributes: {
          class:
            'editor px-8 animate-enter mt-20 md:prose-headings:text-sm max-w-none pb-48 prose-headings:font-medium font-light prose-headings:text-base text-base md:text-sm prose dark:prose-invert prose-neutral py-4 focus:outline-hidden',
        },
      }}
    >
      <Toolbar
