    ...
    return (
      <div
        className={classNames(
          'rounded-xs text-primary flex w-full items-stretch overflow-hidden rounded border border-neutral-200 text-xs shadow-sm focus-within:ring-1 dark:border-neutral-700',
          className
        )}
        ref={ref}
      >
