...
export const ContextMenu = ({ children, ...props }: ContextMenuPrimitive.ContextMenuProps) => {
  return <ContextMenuPrimitive.Root {...props}>{children}</ContextMenuPrimitive.Root>
}

const ContextMenuTrigger = forwardRef(
  ({ className, ...props }: ContextMenuPrimitive.ContextMenuTriggerProps, ref: Ref<HTMLButtonElement>) => {
    return <ContextMenuPrimitive.Trigger className={classNames(className)} ref={ref} {...props} />
  }
)
...
const ContextMenuContent = forwardRef(
  ({ className, ...props }: ContextMenuPrimitive.ContextMenuContentProps, ref: Ref<HTMLDivElement>) => {
    return (
...
const ContextMenuItem = forwardRef(
  ({ className, ...props }: ContextMenuPrimitive.ContextMenuItemProps, ref: Ref<HTMLDivElement>) => {
    return (
...
const ContextMenuSubTrigger = forwardRef(
  ({ className, ...props }: ContextMenuPrimitive.ContextMenuSubTriggerProps, ref: Ref<HTMLDivElement>) => {
    return (
...
const ContextMenuSubContent = forwardRef(
  ({ className, ...props }: ContextMenuPrimitive.ContextMenuSubContentProps, ref: Ref<HTMLDivElement>) => {
    return (
...
const ContextMenuSeparator = forwardRef(
  ({ className, ...props }: ContextMenuPrimitive.ContextMenuSeparatorProps, ref: Ref<HTMLHRElement>) => {
    return (
