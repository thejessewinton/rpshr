    ...
    <div className='mx-auto mt-40'>
      ...
      <div className='space-y-4 text-sm leading-loose text-neutral-700 dark:text-neutral-400'>
        <div className='flex gap-1'>
          <h2 className='animate-enter font-medium text-neutral-950 dark:text-white'>Breathe.</h2>
          <h2 className='animate-enter font-medium text-neutral-950 [animation-delay:750ms] dark:text-white'>Focus.</h2>
        ...
        <div className='space-y-4'>
          ...
          <p className='animate-enter [animation-delay:5250ms]'>Just a focus on the words.</p>

          <a href={'/login'} className='animate-enter block text-neutral-950 [animation-delay:8000ms] dark:text-white'>
            Start now
          </a>
        </div>
      </div>
